          ...
          <div className="bg-white rounded-3xl shadow-xl border border-gray-100 mb-12 overflow-hidden">
            ...
            <div className="p-8">
              {view === "my-tasks" && filter === "my-completed" && showHistory ? (
                ...
                <EmptyState 
                  title={view === "all-tasks" ? "No team tasks" : "No tasks"} 
                  description={view === "all-tasks" ? "Team tasks will appear here" : "Your assigned tasks will appear here"}
                />
              ) : (
                <TaskList
                  tasks={filteredTasks}
